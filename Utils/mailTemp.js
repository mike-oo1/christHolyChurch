        ...
        <div style="max-width: 600px; margin: 0 auto;">
          ...
          <table align="center" role="presentation" cellspacing="0" cellpadding="0" border="0" width="100%" style="margin: auto;">
                  ...
                  <table role="presentation" border="0" cellpadding="0" cellspacing="0" width="100%">
                      <tr>
                          <td style="text-align: center;">
                            <h1 style="margin: 0;"><a href="#" style="color: #30e3ca; font-size: 24px; font-weight: 700; font-family: 'Lato', sans-serif;">BDSM_ARENA</a></h1>
                          </td>
                      </tr>
                  </table>
              </td>
              ...
              <td valign="middle" style="padding: 3em 0 2em 0;">
                <img src="my ass.png" alt="" style="width: 300px; max-width: 600px; height: auto; margin: auto; display: block;">
              </td>
              </tr><!-- end tr -->
                    <tr>
                    ...
                    <tr>
                        <td>
                            <div style="padding: 0 2.5em; text-align: center;">
                                ...
                                <h3 style="font-family: 'fantasy', fantasy; font-size: 24px; font-weight: 300;">Welcome On Board BDSM_ARENA,<br/> HOME OF ADULT TOYS</h3>
                      ...
                      <table role="presentation" cellspacing="0" cellpadding="0" border="0" width="100%">
                        <tr>
                          <td style="text-align: left; padding-right: 10px;">
                              ...
                              <p>we want to make purchase of adult toys seamless</p>
                          </td>
                        </tr>
                      </table>
                    </td>
                        ...
                        <tr>
                          <td style="text-align: left; padding-left: 5px; padding-right: 5px;">
                              ...
                              <ul>
                                        ...
                                        <li><span style="color: rgba(0,0,0,.5);">+234916133743</span></li>
                                      </ul>
                          </td>
                        </tr>
                      </table>
